Ext.data.JsonP.Backgrid_PercentFormatter({
  ...
  "short_doc": "A number formatter that converts a floating point number, optionally\nmultiplied by a multiplier, to a percentage stri...",
  "component": false,
  "superclasses": [
