Ext.data.JsonP.Backgrid_Body({
  ...
  "short_doc": "Body is the table body which contains the rows inside a table. ...",
  "component": false,
  "superclasses": [
    "Backgrid.View"
  ],
